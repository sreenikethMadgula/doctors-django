...
def search_results(request):
    ...
    if request.method=="POST":
        ...
        doctor_list = Doctors.objects.filter(Q(name__icontains=search_doctor_query) | Q(specialization__icontains=search_doctor_query) | Q(hospital__icontains=search_doctor_query))
